...
<div>
  ...
  <a class="navbar-brand" href="javascript:void(0)"><img src="upload/LOGOsample.png" height="60px" width="100px" /></a>
						...
						<div v-if="isLogIn != 'guest'" style="padding-top: 20px;">
							...
							<div class="grid-container">
								<div class="grid-col-12" style="margin-top:10px;padding: 5pt;text-align: center;border-radius: 10px;">
									<div v-for="(item,index) in getCart" class="grid-container productcart">
									
									
											
									
											<div class="grid-col-2">
												<img :src="'upload/'+ item.product.img" style="height: 50px;width: 50px;">
											</div>
        		...
        		<div v-if="isLogIn != 'guest'" style="padding-top: 20px;">
        						<div class="grid-container">
									<div class="grid-col-12" style="text-align:center">
										...
										<img :src="'upload/'+userinfo.img" style="width:150px;height:100px;margin-bottom: 20px;">
